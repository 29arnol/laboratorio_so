	    ...
	    <tbody class="size_font">
	      <tr>
	        ...
	        <td><?php echo $fecha_ingreso ?></td>
	         <td class="text-center"><a class="btn btn-info" style="color: white;" href="psicologia_citas.php?historia=<?php echo $id; ?>&&estado=Atencion En Curso&&iniciotime=<?php echo $horactual; ?>"><b>Atender</b></a></td> 

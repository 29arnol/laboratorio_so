   ...
   <style type="text/css">
    ...
    .centrar {
      ...
      function buscar() {
          ...
          if (textoBusqueda != " ") {
              $.post("medico_buscar.php", {valorBusqueda: textoBusqueda}, function(mensaje) {
...
<body>
  <?php include ('bar/navbar_medico.php'); ?>

    <br><br>
  <!---->
  <form method="POST" target="_blank" action="medico_result.php"> 
    <div class="container">  

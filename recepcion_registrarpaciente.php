...
<?php 
  ...
  WHERE  dc.numero_documento='$documento' ORDER BY db.fecha DESC LIMIT 1";
          ...
          <div class="col-sm-12">
            <table class="table table-bordered">
              <thead>
                ...
                <tr>
                	<th class="table_sizefont">Analfabeta</th>
                	<th class="table_sizefont">Primaria Completa</th>
                	<th class="table_sizefont">Primaria Incompleta</th>
                	<th class="table_sizefont">Secundaria Completa</th>
                	<th class="table_sizefont">Secundaria Incompleta</th>
                	<th class="table_sizefont">Tecnico</th>
                	<th class="table_sizefont">Tecnologo</th>
                	<th class="table_sizefont">Universitario</th>
                	<th class="table_sizefont">Post Grado</th>
                </tr>
              </thead>
              <tbody class="text-center">
                <tr>
...
<form  method="POST" id="formulario" name="formulario">
  <div class="container">
    <div class="panel panel-default">
      <div class="panel-heading text-center"><h6>Motivo de Evaluacion</h6> <label for="motivoevaluacion" generated="true" class="error"></label></div>
      <div class="panel-body">
        <div class="row">
          <div class="container-fluid">
            <table class="table table-bordered">
  	...
  	<div class="panel panel-default">
  	  <div class="panel-heading text-center"><h6>Identificacion Empresa</h6></div>
  	  <div class="panel-body">
        <div class="container-fluid">
          <div class="row">    
    	      <div class="col-sm-12">
	  ...
	  <div class="panel panel-default">
	  	<div class="panel-heading text-center"><h6>Identificación del Trabajador:</h6></div>
	    <div class="panel-body">
        <div class="container-fluid">
          <div class="row">
    	      <div class="col-sm-12"><br> 
    ...
    <div class="container">      
      <div class="panel panel-default">
        <div class="panel-heading text-center"><label><h6>Citar Paciente En:</h6></label></div>
        <div class="panel-body">
          <div class="row">
            <div class="container-fluid">
              <div class="text-center" >
      ...
      <div class="container-fluid">
  		  <div class="text-center"><br> 
  		    <input type="submit" id="btn" name="Registrocompleto" value="Registrar" class="btn btn-success">
  		  </div>
      </div>
		</div><br>
  </form>

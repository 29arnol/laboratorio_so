...
<div style="font-size: 20px;" class="text-center">
	<i class="fas fa-sync fa-spin"></i>
	 Fecha: <?php  echo $fecha ." - Hora:". $horactual; ?>       
</div>      
	    ...
	    <tbody>
	      <tr class="text-center">
	        ...
	        <td><?php echo $fecha_ingreso ?></td>
	         <td class="text-center"><a class="btn btn-info" style="color: white;" href="medico_citas.php?historia=<?php echo $id; ?>&&estado=Atencion En Curso&&iniciotime=<?php echo $horactual; ?>"><b>Atender</b></a></td> 

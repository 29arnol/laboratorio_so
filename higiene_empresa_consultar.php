   ...
   <style type="text/css">
    ...
    .centrar {
      ...
      function buscar() {
          ...
          if (textoBusqueda != " ") {
              $.post("higiene_empresa_buscar.php", {valorBusqueda: textoBusqueda}, function(mensaje) {
...
echo $consultaBusqueda;*/
  ...
  <div class="container">
  <div class="col-sm-12">
    <h2 class="text-center" style= "color: #0685E5;" >Registrar Estudio de Medicion</h2>
    <label><span class="glyphicon glyphicon-search"></span> Buscar Empresa en el Sistema:</label>

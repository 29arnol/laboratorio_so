<?php 
  ...
  if ($_GET){ 
    ...
    $data1 = "UPDATE `datos_basicos_atencion` SET `inicio_timeespirometria`= '$inicio' WHERE id_datos_basicos = '$historia'"; 
...
<html>
	<head>
	  <title>Espirometria Pacientes</title>
	  <meta charset="utf-8">
	...
	<script type="text/javascript">
	    function getTimeAJAX() {
	        ...
	        var time = $.ajax({
	            url: 'espirometria_pacientes_atender.php', //indicamos la ruta donde se genera la hora

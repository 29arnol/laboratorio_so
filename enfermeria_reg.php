        ...
        <table class="table table-bordered" id="tablsa">    
          ...
          <tbody id="tabla1">
            <tr class="text-center">
	            <td>
                <input class="form-control input-sm" style="width: 190px;" type="text" name="empresa1_riesgo[]">
                <label for="empresa1_riesgo" generated="true" class="error"></label><br>
              </td>
	            <td colspan="8"><input class="form-control input-sm" type="text" name="factoresriesgo[]"></td>
	            <td><input class="form-control input-sm" type="text" name="riesgo_cargo1[]"></td>
	            <td><input class="form-control input-sm" type="text" name="riesgo_tiempo1[]"></td>
	            <td><input class="form-control input-sm" style="width: 190px;" type="text" name="riesgo_epp1[]"></td> 
            </tr>
          </tbody>
        </table>
          <input type="button" value="Agregar Otro" id="agregarFila1" class="btn-info">
        	<div class="text-center">
...
$(function(){
    ...
    tabla1 = $('#tabla1');
    tr = $('tr:first', tabla1);
    $('#agregarFila1').live('click', function (){
...
$(function(){
    ...
    tabla2 = $('#tabla2');
    tr2 = $('tr:first', tabla2);
    $('#agregarFila2').live('click', function (){
...
$(function(){
    ...
    $('#agregarFila3').live('click', function(){
          ...
          <tbody>
            <tr class="text-center">
              ...
              <td>
                ...
                <input style="width: 80px;" class="form-control input-sm" type="text" name="anosfumador" onkeypress="return esInteger(event)" >
              </td>
                ...
                <input style="width: 80px;" class="form-control input-sm" type="text" name="anosexfumador" onkeypress="return esInteger(event)" >
              </td>

          		<td>
                <label for="cantidad_cigarrillos_dia" generated="true" class="error"></label>
                <input style="width: 80px;" class="form-control input-sm" type="text" name="cantidad_cigarrillos_dia" onkeypress="return esInteger(event)" >
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            <tr class="text-center">
                ...
                <label for="anoshab_beber" generated="true" class="error"></label><br>
          		  <input style="width: 50px;" class="form-control input-sm" type="text" name="anoshab_beber" onkeypress="return esInteger(event)" >
              </td>
                ...
                <label>Ocac:</label> <input type="radio" name="frec_beber" value="Ocacionalmente">
          		...
          		<td>
          		  <label>Cerveza:</label> <input type="checkbox" name="tipolicor[]" value="Cerveza"> | <label>Ron:</label> <input type="checkbox" name="tipolicor[]" value="Ron"> | 
            ...
            <tr class="text-center">
                ...
                <div class="N">
                  <label for="exbebedor_anos" generated="true" class="error"></label><br>
          		    <input style="width: 90px;" class="form-control input-sm" type="text" name="exbebedor_anos" onkeypress="return esInteger(event)" >
                </div>
              </td>
            </tr>
            <thead>

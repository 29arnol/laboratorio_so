	...
	$query = mysqli_query($conexion,$consult);
	    ...
	    <tbody class="size_font">
	      <tr class="text-center">
	        ...
	        <td class="text-center"><a class="btn btn-info fontcolor" href="enfermeria_citas.php?historia=<?php echo $id;?>&&estado=Atencion En Curso&&iniciotime=<?php echo $horactual; ?>"><b>Atender</b></a></td> 
    	...
    	echo '<label class="text-danger">En estos momentos no hay pacientes en espera.<label>';
    }

		      ...
		      <tr>
		        ...
		        <?php if ($audiometria == 'Esperando Atencion') { ?>
		         <td class="text-center <?php echo $clase_audiometria ?>">
		         	<a style="color: #061EFA;" href="recepcion_citas.php?historia=<?php echo $id; ?>&&estado_atencion=Priorizar Esta Atencion&&priorizar=1 ">
		         ...
		         <?php if ($visiometria == 'Esperando Atencion') { ?>
			         <td class="text-center <?php echo $clase_visiometria ?>">
			         	<a style="color: #061EFA;" href="recepcion_citas.php?historia=<?php echo $id; ?>&&estado_atencion=Priorizar Esta Atencion&&priorizar=2 "><b class="<?php echo $clase_visiometria ?>"><?php echo $visiometria ?></b>
			         	</a>
			         </td> 
		         <?php }else{?>
			         <td class="text-center <?php echo $clase_visiometria ?>">
		         ...
		         <td class="text-center <?php echo $clase_espirometria ?>">
		         	<a style="color: #061EFA;" href="recepcion_citas.php?historia=<?php echo $id; ?>&&estado_atencion=Priorizar Esta Atencion&&priorizar=3 ">
		         ...
		         <td class="text-center <?php echo $clase_psicologia ?>">
		         	<a style="color: #061EFA;" href="recepcion_citas.php?historia=<?php echo $id; ?>&&estado_atencion=Priorizar Esta Atencion&&priorizar=4 ">
		         ...
		         <td class="text-center <?php echo $clase_enfermeria ?>">
		         	<a style="color: #061EFA;" href="recepcion_citas.php?historia=<?php echo $id; ?>&&estado_atencion=Priorizar Esta Atencion&&priorizar=5 ">
		         ...
		         <td class="text-center <?php echo $clase_medico ?>">
		         	<a style="color: #061EFA;" href="recepcion_citas.php?historia=<?php echo $id; ?>&&estado_atencion=Priorizar Esta Atencion&&priorizar=6 ">

	...
	if ($filas === 0 or $consultaBusqueda == "") {
		...
		while($resultados = mysqli_fetch_array($consulta)) {
			...
			if ($remision_pendiente == 'Si') {
				$remi = '<td><a target="_blank" href="medico_remision.php?paciente='.$h_code.'"><strong class="text-danger"><span class="glyphicon glyphicon-warning-sign"></span> SI</strong></a></td>';
			  ...
			  <table class="table table-bordered">
			    <thead>
			      <tr>
			        ...
			        <th class="text-center text-danger">Resultado</th>
			        <th class="text-center text-danger" style="color: #808080;">Historia</th>
			        <th class="text-center text-danger">Donwload</th>
			        <th class="text-center text-danger">General</th>
			        <th class="text-center text-danger">CAL</th>
			      </tr>
			    </thead>
			    <tbody class="text-center">
			      <tr>
			        ...
			        <td>'.$nombreempresa.'</td>
			        '.$remi.'
			        <td><a target="_blank" href="medico_listarexamen.php?paciente='.$h_code.'&&tipoconsulta='.$tr_code.'&&registro='.$f_code.'&&cod='.$code.'"><strong><span class="glyphicon glyphicon-eye-open"></span> Ver</strong></a></td>
			        
			 		<td><a target="_blank" href="medico_listarexamen.php?paciente='.$h_code.'&&tipoconsulta='.$th_code.'&&registro='.$f_code.'&&cod='.$code.'"><strong><span class="glyphicon glyphicon-eye-open"></span> Ver</strong></a></td>

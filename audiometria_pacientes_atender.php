...
?>
 <body>
    <div style="font-size: 20px;" class="text-center"><label>Fecha: </label> <?php  echo $time; ?></div>   
		    ...
		    <tbody class="size_font">
		      <tr class="text-center">
		        ...
		        <td><?php echo $fecha_ingreso ?></td>
		         <td class="text-center"><a class="btn btn-info" style="color: white;" href="audiometria_pacientes.php?historia=<?php echo $id; ?>&&estado=Atencion En Curso&&iniciotime=<?php echo $horactual; ?>"><b>Atender</b></a></td> 

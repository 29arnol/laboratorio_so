			...
			?>
			    <tbody class="size_font">
			      <tr class="text-center">
			        ...
			        <td class="text-center"><a class="btn btn-info" style="color: white;" href="visiometria_citas.php?historia=<?php echo $id; ?>&&estado=Atencion En Curso&&iniciotime=<?php echo $horactual; ?>"><b>Atender</b></a></td>

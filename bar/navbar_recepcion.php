...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav navbar-nav navbar-left">
      <li class="nav-item">
        <a class= "nav-link" href="recepcion_pacientes.php"><span class="fas fa-notes-medical"></span> CITAS</a>
      </li>
      <li class="nav-item">
        <a class= "nav-link" target="_blank" href="recepcion.php"><span class="fa fa-user-plus"></span> REGISTRAR PACIENTE</a>
      </li>
      <li class="nav-item">
        <a class= "nav-link" target="_blank" href="recepcion_resultados_paciente.php"><span class="fa fa-search"></span> 
         CONSULTAR</a>
      </li>
      ...
      <li class="dropdown nav-item">
        ...
        <ul class="dropdown-menu ground" id="menu">
          <li class="nav-item">
            ...
            <a class= "dropdown-item size_font" href="recepcion_consulta_equipos.php"><span class="fa fa-search"></span> CONSULTAR EQUIPOS DE LABORATORIO</a>

            <a class= "dropdown-item size_font" href="recepcion_consulta_prestados.php"><span class="fa fa-search"></span> CONSULTAR EQUIPOS PRESTADOS</a>
          </li>
        </ul>
      </li> 
    </ul>

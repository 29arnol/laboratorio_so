...
if (isset($consultaBusqueda)) {
	...
	JOIN audiometria_resultado_der AS ard ON ard.paciente_audiometria = db.id_historia
			  ...
			  <table class="table table-bordered">
			    ...
			    <tbody>
			      <tr>
			        ...
			        <td>'. $fecha .'</td>
			        <td>'. $nombreempresa .'</td>
			 		<td><a target="_blank" href="audiometria_result.php?paciente='.$h_code.'&&tipoconsulta='.$R_code.'&&cod='.$code.'&&registro='.$f_code.'"><strong><span class="glyphicon glyphicon-eye-open"></span> Consultar</strong></a></td>

			 		<td><a target="_blank" href="audiometria_result.php?paciente='.$h_code.'&&tipoconsulta='.$t_code.'&&cod='.$code.'&&registro='.$f_code.'"><strong><span class="glyphicon glyphicon-eye-open"></span> Consultar</strong></a></td>

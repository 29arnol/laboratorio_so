...
if (isset($consultaBusqueda)){
	...
	JOIN psicologia_estadomental AS peem ON peem.paciente_psicologia = db.id_historia 
			  ...
			  <table class="table table-bordered">
			    <thead>
			      <tr>
			        ...
			        <th class="text-center text-danger">Listar consulta</th>
			    ...
			    <tbody>
			      <tr class="text-center text-dark">
			        ...
			        <td>'.$fecha.'</td>
			        <td>'.$nombreempresa.'</td>
			 		<td><a target="_blank" href="psicologia_listarexamen.php?paciente='.$h_code.'&&registro='.$f_code.'&&tipoconsulta='.$t_code.'&&cod='.$code.'"><strong>Consultar</strong></a></td>

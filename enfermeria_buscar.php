...
if (isset($consultaBusqueda)) {
	...
	JOIN historia_laboral AS hl ON hl.paciente_enfermeria = db.id_historia 
			  ...
			  <table class="table table-bordered">
			    ...
			    <tbody>
			      <tr class="text-center">
			        ...
			        <td>'. $fecha .'</td>
			        <td>'. $nombreempresa .'</td>
			 		<td class="text-center"><a target="_blank" href="enfermeria_result.php?paciente='.$h_code.'&&registro='.$f_code.' &&tipoconsulta='.$t_code.'&&cod='.$code.'"><strong>Consultar</strong></a></td>

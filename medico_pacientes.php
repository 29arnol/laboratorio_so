...
<html>
  ...
  <?php 
    ...
    if ($_GET){ 
      ...
      $data = "UPDATE `db_estado_atencion` SET `medico`= '$estado' WHERE paciente = '$historia'"; 
      $query2 = mysqli_query($conexion,$data);

      $data1 = "UPDATE `datos_basicos_atencion` SET `inicio_timemedico`= '$inicio' WHERE id_datos_basicos = '$historia'"; 
  ...
  <script type="text/javascript">
    function getTimeAJAX() {
      ...
      var time = $.ajax({
        url: 'medico_pacientes_atender.php', //indicamos la ruta donde se genera la hora

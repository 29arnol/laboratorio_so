...
<?php 
	...
	WHERE fecha = '$fecha' ORDER BY hora ASC";
	  ...
	  <table class="table table-bordered">
	    ...
	    <tbody class="size_font">
	      <tr class="text-center">
	        ...
	        <td class="text-center"><a class="btn btn-info" style="color: white;" href="enfermeria_pacientes.php?historia=<?php echo $id; ?>&&estado=Atencion En Curso&&iniciotime=<?php echo $horactual; ?>"><b>Atender</b></a></td> 
    	...
    	echo "<label Style='color: red;'>En Estos Momentos No Hay Pacientes En Espera.<label>";
    }
